...
[✅] Elastic_L30_C1 + Random Undersample on baseline_easy_w5_n5_d0.csv → PR AUC: 0.722
[✅] Elastic_L30_C1 + Cluster Centroids on baseline_easy_w5_n5_d0.csv → PR AUC: 0.677
[✅] Elastic_L30_C1 + No Resampling on baseline_easy_w5_n5_d0.csv → PR AUC: 0.689
...
[✅] Elastic_L30_C1 + Random Undersample on imbalanced_sparse_w0_n10_d10.csv → PR AUC: 0.034
[✅] Elastic_L30_C1 + Cluster Centroids on imbalanced_sparse_w0_n10_d10.csv → PR AUC: 0.094
[✅] Elastic_L30_C1 + No Resampling on imbalanced_sparse_w0_n10_d10.csv → PR AUC: 0.024
...
[✅] Elastic_L30_C1 + ADASYN on mixed_realistic_w4_n15_d30.csv → PR AUC: 0.159
...
[✅] Elastic_L30_C1 + ADASYN on noisy_overlap_w2_n20_d0.csv → PR AUC: 0.039
...
[✅] Elastic_L50_C5 + ADASYN on baseline_easy_w5_n5_d0.csv → PR AUC: 0.527
[✅] Elastic_L50_C5 + Borderline SMOTE on baseline_easy_w5_n5_d0.csv → PR AUC: 0.518
...
[✅] Elastic_L50_C5 + Random Undersample on baseline_easy_w5_n5_d0.csv → PR AUC: 0.713
[✅] Elastic_L50_C5 + Cluster Centroids on baseline_easy_w5_n5_d0.csv → PR AUC: 0.650
[✅] Elastic_L50_C5 + No Resampling on baseline_easy_w5_n5_d0.csv → PR AUC: 0.686
...
[✅] Elastic_L50_C5 + Cluster Centroids on high_drift_w3_n10_d60.csv → PR AUC: 0.158
...
[✅] Elastic_L50_C5 + SMOTE on imbalanced_sparse_w0_n10_d10.csv → PR AUC: 0.038
[✅] Elastic_L50_C5 + ADASYN on imbalanced_sparse_w0_n10_d10.csv → PR AUC: 0.037
[✅] Elastic_L50_C5 + Borderline SMOTE on imbalanced_sparse_w0_n10_d10.csv → PR AUC: 0.025
[✅] Elastic_L50_C5 + SMOTETomek on imbalanced_sparse_w0_n10_d10.csv → PR AUC: 0.038
[✅] Elastic_L50_C5 + SMOTEENN on imbalanced_sparse_w0_n10_d10.csv → PR AUC: 0.037
[✅] Elastic_L50_C5 + Random Undersample on imbalanced_sparse_w0_n10_d10.csv → PR AUC: 0.020
[✅] Elastic_L50_C5 + Cluster Centroids on imbalanced_sparse_w0_n10_d10.csv → PR AUC: 0.044
[✅] Elastic_L50_C5 + No Resampling on imbalanced_sparse_w0_n10_d10.csv → PR AUC: 0.023
[✅] Elastic_L50_C5 + Manual Upsampling on mixed_realistic_w4_n15_d30.csv → PR AUC: 0.148
[✅] Elastic_L50_C5 + SMOTE on mixed_realistic_w4_n15_d30.csv → PR AUC: 0.142
...
[✅] Elastic_L50_C5 + SMOTETomek on mixed_realistic_w4_n15_d30.csv → PR AUC: 0.142
[✅] Elastic_L50_C5 + SMOTEENN on mixed_realistic_w4_n15_d30.csv → PR AUC: 0.142
[✅] Elastic_L50_C5 + Random Undersample on mixed_realistic_w4_n15_d30.csv → PR AUC: 0.133
[✅] Elastic_L50_C5 + Cluster Centroids on mixed_realistic_w4_n15_d30.csv → PR AUC: 0.171
...
[✅] Elastic_L70_C10 + ADASYN on baseline_easy_w5_n5_d0.csv → PR AUC: 0.517
[✅] Elastic_L70_C10 + Borderline SMOTE on baseline_easy_w5_n5_d0.csv → PR AUC: 0.514
...
[✅] Elastic_L70_C10 + Cluster Centroids on baseline_easy_w5_n5_d0.csv → PR AUC: 0.647
[✅] Elastic_L70_C10 + No Resampling on baseline_easy_w5_n5_d0.csv → PR AUC: 0.687
...
[✅] Elastic_L70_C10 + Cluster Centroids on imbalanced_sparse_w0_n10_d10.csv → PR AUC: 0.043
[✅] Elastic_L70_C10 + No Resampling on imbalanced_sparse_w0_n10_d10.csv → PR AUC: 0.048
...
[✅] Elastic_L70_C10 + Cluster Centroids on noisy_overlap_w2_n20_d0.csv → PR AUC: 0.039
...
[✅] Elastic_L100_C10 + SMOTE on baseline_easy_w5_n5_d0.csv → PR AUC: 0.669
[✅] Elastic_L100_C10 + ADASYN on baseline_easy_w5_n5_d0.csv → PR AUC: 0.516
[✅] Elastic_L100_C10 + Borderline SMOTE on baseline_easy_w5_n5_d0.csv → PR AUC: 0.510
[✅] Elastic_L100_C10 + SMOTETomek on baseline_easy_w5_n5_d0.csv → PR AUC: 0.669
[✅] Elastic_L100_C10 + SMOTEENN on baseline_easy_w5_n5_d0.csv → PR AUC: 0.666
[✅] Elastic_L100_C10 + Random Undersample on baseline_easy_w5_n5_d0.csv → PR AUC: 0.712
[✅] Elastic_L100_C10 + Cluster Centroids on baseline_easy_w5_n5_d0.csv → PR AUC: 0.648
[✅] Elastic_L100_C10 + No Resampling on baseline_easy_w5_n5_d0.csv → PR AUC: 0.686
...
[✅] Elastic_L100_C10 + No Resampling on imbalanced_sparse_w0_n10_d10.csv → PR AUC: 0.017
[✅] Elastic_L100_C10 + Manual Upsampling on mixed_realistic_w4_n15_d30.csv → PR AUC: 0.148
[✅] Elastic_L100_C10 + SMOTE on mixed_realistic_w4_n15_d30.csv → PR AUC: 0.141
...
[✅] Elastic_L100_C10 + SMOTETomek on mixed_realistic_w4_n15_d30.csv → PR AUC: 0.141
...
[✅] Elastic_L100_C10 + Cluster Centroids on mixed_realistic_w4_n15_d30.csv → PR AUC: 0.163
...
[✅] Elastic_L100_C10 + Cluster Centroids on noisy_overlap_w2_n20_d0.csv → PR AUC: 0.039
[✅] Elastic_L100_C10 + No Resampling on noisy_overlap_w2_n20_d0.csv → PR AUC: 0.040
[✅] Elastic_L0_C10 + Manual Upsampling on baseline_easy_w5_n5_d0.csv → PR AUC: 0.683
[✅] Elastic_L0_C10 + SMOTE on baseline_easy_w5_n5_d0.csv → PR AUC: 0.669
[✅] Elastic_L0_C10 + ADASYN on baseline_easy_w5_n5_d0.csv → PR AUC: 0.518
[✅] Elastic_L0_C10 + Borderline SMOTE on baseline_easy_w5_n5_d0.csv → PR AUC: 0.517
...
[✅] Elastic_L0_C10 + Random Undersample on baseline_easy_w5_n5_d0.csv → PR AUC: 0.707
[✅] Elastic_L0_C10 + Cluster Centroids on baseline_easy_w5_n5_d0.csv → PR AUC: 0.642
[✅] Elastic_L0_C10 + No Resampling on baseline_easy_w5_n5_d0.csv → PR AUC: 0.687
[✅] Elastic_L0_C10 + Manual Upsampling on high_drift_w3_n10_d60.csv → PR AUC: 0.150
...
[✅] Elastic_L0_C10 + SMOTEENN on imbalanced_sparse_w0_n10_d10.csv → PR AUC: 0.036
...
[✅] Elastic_L0_C10 + No Resampling on imbalanced_sparse_w0_n10_d10.csv → PR AUC: 0.032
...
[✅] Elastic_L0_C10 + ADASYN on mixed_realistic_w4_n15_d30.csv → PR AUC: 0.159
...
[✅] Elastic_L0_C10 + Cluster Centroids on mixed_realistic_w4_n15_d30.csv → PR AUC: 0.153
